...
import torchvision.transforms as trans  # noqa: E402
from configs.paths_config import model_paths  # noqa: E402
from models.encoders.model_irse import IR_101  # noqa: E402
from models.mtcnn.mtcnn import MTCNN  # noqa: E402
...
def run(args):
    ...
    result_str = "New Average score is {:.8f}+-{:.8f}".format(mean, std)
    print(result_str)
